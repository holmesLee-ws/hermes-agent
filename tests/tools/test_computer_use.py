...
class TestSchema:
    ...
    def test_schema_does_not_impose_blanket_ui_or_secret_action_bans(self):
        ...
        for forbidden in ("never click password", "permission", "payment ui", "type secrets"):
    ...
    def test_packaged_guidance_omits_blanket_ui_and_secret_action_bans(self):
        ...
        for path in paths:
            ...
            for forbidden in ("never click permission dialogs", "password prompts", "payment ui", "type secrets"):
